<%-- 
    ...
    Created on : 14 Dec, 2024, 5:25:40 PM
    Author     : saksh
--%>
    ...
    <body>
        <header>
            <div class="header-content">
                ...
                <form action="hotel_booking.jsp" method="post">
                    <label for="criteria">Search By:</label>
                    <select id="criteria" name="criteria">
                        <option value="name">Place Name</option>
                        <option value="Haddress">Address</option>
                        <option value="Harea">Area</option>
                    </select>
        ...
        %>
            <div class="content-Div-Hotel">
                ...
                <div class="hotel-text">
                    ...
                    <p>
                        <strong>Area: <%=rs.getString("Harea")%></strong><br>
                        <strong>Address: <%=rs.getString("Haddress")%></strong>
                    </p>
